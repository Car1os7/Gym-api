...
const options = {
  definition: {
    ...
    tags: [
      { name: 'Planos', description: 'Operações relacionadas a planos' },
      { name: 'Membros', description: 'Operações relacionadas a membros' },
      { name: 'Treinos', description: 'Operações relacionadas a treinos' }
    ]
  },
  apis: ['./src/routes/*.ts'],
};
